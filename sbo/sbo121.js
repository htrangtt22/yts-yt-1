    ...
    .sbo121-grid-container > div {
        grid-column: span 1 !important;
                    ...
                    <div class="container">
                        ...
                        <!-- 1. What is Medical Ethics - Visual Dual Cards -->
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 35px;">
                            
                            <!-- Bioethics (Sinh đạo đức) Card -->
                            <div style="background: rgba(45, 212, 191, 0.02); border: 1px solid rgba(45, 212, 191, 0.15); border-radius: 12px; padding: 25px; text-align: center; box-shadow: 0 4px 20px rgba(45, 212, 191, 0.02);">
                                <div style="display: inline-flex; align-items: center; justify-content: center; width: 50px; height: 50px; border-radius: 50%; background: rgba(45, 212, 191, 0.1); color: var(--accent-teal); margin-bottom: 12px; font-size: 1.3rem;">
                                    <i class="fa-solid fa-microscope"></i>
                                </div>
                                <h3 style="margin: 0 0 10px 0; font-size: 1.15rem; color: var(--accent-teal); font-weight: bold;">
                                    <span class="lang-ja">生命倫理 (Bioethics)</span>
                                    <span class="lang-vi">Đạo đức sinh học (Bioethics)</span>
                                </h3>
                                <p style="font-size: 0.96rem; line-height: 1.6; color: var(--text-secondary); margin: 0;">
                                    <span class="lang-ja">「医学研究における倫理」。先端技術応用や人体実験のルール策定。</span>
                                    <span class="lang-vi">Đạo đức trong nghiên cứu y học. Thiết lập quy tắc áp dụng công nghệ và thử nghiệm.</span>
                                </p>
                            </div>

                            <!-- Clinical Ethics (Đạo đức lâm sàng) Card -->
                            <div style="background: rgba(245, 158, 11, 0.02); border: 1px solid rgba(245, 158, 11, 0.15); border-radius: 12px; padding: 25px; text-align: center; box-shadow: 0 4px 20px rgba(245, 158, 11, 0.02);">
                                <div style="display: inline-flex; align-items: center; justify-content: center; width: 50px; height: 50px; border-radius: 50%; background: rgba(245, 158, 11, 0.1); color: var(--accent-gold); margin-bottom: 12px; font-size: 1.3rem;">
                                    <i class="fa-solid fa-user-doctor"></i>
                                </div>
                                <h3 style="margin: 0 0 10px 0; font-size: 1.15rem; color: var(--accent-gold); font-weight: bold;">
                                    <span class="lang-ja">臨床倫理 (Clinical Ethics)</span>
                                    <span class="lang-vi">Đạo đức lâm sàng (Clinical Ethics)</span>
                                </h3>
                                <p style="font-size: 0.96rem; line-height: 1.6; color: var(--text-secondary); margin: 0;">
                                    <span class="lang-ja">「医療現場における倫理」。実際の治療や現場での自己決定権の尊重。</span>
                                    <span class="lang-vi">Đạo đức trong thực hành y tế. Điều trị và tôn trọng quyền tự quyết tại giường bệnh.</span>
                                </p>
                            </div>
                        ...
                        <div class="sbo121-flex-container" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 24px; margin-bottom: 30px;">
                            
                            <!-- Item 1: Shift from Paternalism to Autonomy -->
                            <div class="card glass-card" style="border-left: 4px solid var(--accent-gold); padding: 25px; flex: 1 1 calc(33.333% - 24px); min-width: 340px; max-width: 460px; display: flex; align-items: flex-start; gap: 16px; margin-bottom: 0;">
                            ...
                            <div class="card glass-card" style="border-left: 4px solid var(--accent-teal); padding: 25px; flex: 1 1 calc(33.333% - 24px); min-width: 340px; max-width: 460px; display: flex; align-items: flex-start; gap: 16px; margin-bottom: 0;">
                            ...
                            <div class="card glass-card" style="border-left: 4px solid #a855f7; padding: 25px; flex: 1 1 calc(33.333% - 24px); min-width: 340px; max-width: 460px; display: flex; align-items: flex-start; gap: 16px; margin-bottom: 0;">
